...
import { toggleCart , removeFromCart, getTotalPrice, changeQuantity } from '../rtk/slices/shoppingCartSlice'
...
export default function ShoppingCart() {
    const activeShoppingCart = useSelector((state) => state.shoppingCart.openShoppingCart);
                                ...
                                <div className="flow-root">
                                    ...
                                    {Object.values(cart).map((product , i) => (
                                        ...
                                        <div className="h-24 w-24 flex items-center flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                                            ...
                                            src={product.image}
                                            alt={product.title}
                                            className="max-h-full max-w-full m-auto p-3  object-cover object-center"
                                            />
                                        </div>
                                            ...
                                            <div className="flex flex-1 items-end justify-between text-sm">
                                                    <div className="text-gray-500">
                                                        Qty
                                                            ...
                                                            <input type='number' className='w-10 h-8 pl-2 border ml-2 rounded-lg border-gray-200' min={0} value={product.quantity || ''}
                                                                onChange={(e) => {
                                                                    dispatch(changeQuantity({ id: product.id, quantity: +e.target.value }))
                                                                }}
                                                                onBlur={
                                                                    (e) => {
                                                                        e.preventDefault();
