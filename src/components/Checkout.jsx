...
export default function Checkout() {
  ...
  function sendOrder(e) {
    ...
    e.preventDefault();
    emailjs.sendForm('service_itc1xmn', 'template_6wd437k', form.current, { publicKey: '6BcAHK70njlIj9mxw' });
    setTimeout(() => {
  ...
  return (
    Object.keys(cart).length === 0 ?
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <p className='sm:text-4xl font-semibold mt-5 text-3xl text-sky-400'>Your Cart Is Empty</p>
        <p className='text-sky-300 text-xl mt-2'>Let&apos;s add some <Link className='text-indigo-700' to={'/products'}>products</Link> </p>
    </div> :
      <div className="isolate bg-white dark:bg-slate-900 px-6 py-24 sm:py-32 lg:px-8">
              ...
              <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-3xl font-bold tracking-tight dark:text-teal-50 text-gray-900 sm:text-4xl">Confirm Order</h2>
                {/* <p className="mt-2 text-lg leading-8 text-gray-600">
                  Aute magna irure deserunt veniam aliqua magna enim voluptate.
                </p> */}
              </div>
              <form ref={form} onSubmit={sendOrder} action="#" method="POST" className="group mx-auto mt-16 max-w-xl sm:mt-20" >
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                  <div>
                    <label htmlFor="first-name" className="block text-sm font-semibold leading-6 text-gray-900 dark:text-teal-50">
                      First name
                    </label>
                  ...
                  <div>
                    <label htmlFor="last-name" className="block text-sm font-semibold leading-6 text-gray-900 dark:text-teal-50">
                      Last name
                    </label>
                    <div className="mt-2.5">
                      <input
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="adress" className="block text-sm font-semibold leading-6 text-gray-900 dark:text-teal-50">
                      Address
                    </label>
                    <div className="mt-2.5">
                        <input
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="email" className="block text-sm font-semibold leading-6 dark:text-teal-50 text-gray-900">
                      Email
                    </label>
                    <div className="mt-2.5">
                      <input
                  ...
                  <div className="sm:col-span-2">
                    <label htmlFor="phone-number" className="block text-sm font-semibold leading-6 dark:text-teal-50 text-gray-900">
                      Phone number
                    </label>
          ...
          <input type="text" name='orderDetails' className='hidden'
            defaultValue={
`
