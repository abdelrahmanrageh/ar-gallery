      ...
      <section className=" h-full mx-auto max-w-6xl p-3 md:p-4">
        ...
        <div className="grid max-w-screen-xl px-4 py-10 lg:py-0 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link
              to="/products"
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-semibold text-center text-[#0b132a]  rounded-lg bg-[#8cf1f3]   hover:bg-[#a7fafb] "
            >
              Shop Products
              <svg
                className="w-5 h-5 ml-2 -mr-1 transition-none"
                fill="currentColor"
                viewBox="0 0 20 20"
