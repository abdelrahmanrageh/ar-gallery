...
export default function SuccessAlert({ message }) {
  <div
    ...
    className="p-4 mb-4 fixed top-24 shadow-md dark:shadow-slate-700  md:right-5 right-1/2 translate-x-1/2 w-[80%]  md:max-w-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800"
    role="alert"
  >
